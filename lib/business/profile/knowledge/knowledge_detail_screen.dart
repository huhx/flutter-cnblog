...
class KnowledgeDetailScreen extends StatefulHookConsumerWidget {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              final bool isMark = await bookmarkApi.isMark(widget.knowledge.url);
              ...
              showMaterialModalBottomSheet(
                ...
                builder: (_) => BlogShareScreen(blog: widget.knowledge.toBlogShare(), shareSetting: setting),
              );
            },
          )
        ],
        ...
        children: [
          InAppWebView(
            onWebViewCreated: (controller) async {
              final String string = await htmlCssApi.injectCss(widget.knowledge.url, ContentType.knowledge);
